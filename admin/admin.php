...
function displayUsers() {
    ...
    echo "<tr><td><b>Vartotojo vardas</b></td><td><b>Lygis</b></td><td><b>El. paštas</b></td><td><b>Paskutinį kartą aktyvus</b></td></tr>\n";
...
/**
 * viewActiveUsers - Displays currently logged in users
 * database table in a nicely formatted html table.
 */
...
<?
/**
 * If user isn't an administrator, redirect to main page
 * automatically.
 */
if (!$session->isAdmin()) {
    ...
    if ($form->num_errors > 0) {
        echo "<font size=\"4\" color=\"#ff0000\">"
            . "!*** Klaida užklausimo formoje, prašome, patikrinkite</font><br><br>";
    }
    ?>
